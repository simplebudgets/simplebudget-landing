...
import editCategory from '../../assets/screenshots/simplebudget/edit_category.png';
import editCategoryHelpers from '../../assets/screenshots/simplebudget/edit_category_helpers.png';
import viewCategoryExpense from '../../assets/screenshots/simplebudget/view_category_expense.png';
import viewCategoryIncome from '../../assets/screenshots/simplebudget/vew_category_income.png';
...
Tap any category to see its details. The view differs slightly depending on whether it's an income or expense category:

<div class="guide-screenshot-row">
  <Image src={viewCategoryIncome} alt="Viewing an income category with budgeted and actual amounts" width={300} class="guide-screenshot" />
  <Image src={viewCategoryExpense} alt="Viewing an expense category with budgeted, spent, and remaining amounts" width={300} class="guide-screenshot" />
</div>
...
<Image src={editCategory} alt="Editing a category name and budgeted amount" width={300} class="guide-screenshot" />

The edit screen also includes helper options for managing your category:

<Image src={editCategoryHelpers} alt="Category edit helpers including move and delete options" width={300} class="guide-screenshot" />
